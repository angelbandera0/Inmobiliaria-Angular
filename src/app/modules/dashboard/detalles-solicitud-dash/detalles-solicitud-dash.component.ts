...
@Component({
  selector: 'app-detalles-solicitud-dash',
  templateUrl: './detalles-solicitud-dash.component.html',
  styleUrls: ['./detalles-solicitud-dash.component.css'],
})
export class DetallesSolicitudDashComponent implements OnInit {
  id!: string;
  isLoadImg = false;
  solicitud!: Solicitud;
  constructor(
